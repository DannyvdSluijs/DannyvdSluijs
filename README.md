...
- [MyParcelCOM/api-sdk-php](https://github.com/MyParcelCOM/api-sdk-php) (3 days ago)
...
- [Allow `psr/http-message` v2 to increase compatibility with other packages](https://github.com/MyParcelCOM/api-sdk-php/pull/246) on [MyParcelCOM/api-sdk-php](https://github.com/MyParcelCOM/api-sdk-php) (3 days ago)
